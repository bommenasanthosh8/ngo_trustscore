...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-64 border-r border-surface-border bg-surface-card/30 backdrop-blur-sm">
      {/* Logo */}
      <div className="flex items-center gap-3 px-6 py-5 border-b border-surface-border">
        ...
        <div>
          <div className="text-sm font-bold text-white leading-tight">NGO Transparency</div>
